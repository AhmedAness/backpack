...
import com.wasltec.provider.CalenderLib.utils.CalendarUtils;
...
public class CustomCalendarView extends LinearLayout {
    ...
    List<ActivityCalenderModel> calendardata= new ArrayList<>();
    ...
    private int aval_day;
    private int not_aval_day;
    private int red;
...
//            dayOfMonthContainer.setOnClickListener(onDayOfMonthClickListener);
            ...
            if (null != getCustomTypeface()) {
                dayView.mTitle.setTypeface(getCustomTypeface());
            }
            ...
            if (CalendarUtils.isSameMonth(calendar, startCalendar)) {
                ...
                if (is_in_aval(calendar, calendardata)!=null){
                    ...
                    if (CalendarUtils.isPastDay (startCalendar.getTime())){
                        ...
                        dayView.mSubtitle.setText("");
                        dayView.mSubtitle2.setText("");
                        dayView.decorate();
...
//                        dayView.mTitle.setBackgroundColor(disabledDayTextColor);
                    ...
                    if (CalendarUtils.isPastDay (startCalendar.getTime()))
                    {
                        ...
                        dayView.mSubtitle2.setTextColor(dayOfWeekTextColor);
                        dayView.mSubtitle2.setBackgroundColor(disabledDayTextColor);
...
//            dayView.decorate();
    ...
    private ActivityCalenderModel is_in_aval(Calendar startCalendar, List<ActivityCalenderModel> calendardata) {
    ...
    public void markDayAsSelectedDay(Date currentDate) {
        ...
        view.mTitle.setTextColor(selectedDayTextColor);
    }
    ...
    private OnClickListener onDayOfMonthClickListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            calendar.setFirstDayOfWeek(getFirstDayOfWeek());
            calendar.setTime(currentCalendar.getTime());
            calendar.set(Calendar.DAY_OF_MONTH, Integer.valueOf(dayOfMonthText.mTitle.getText().toString()));
            ...
            if (calendarListener != null)
            {
                ActivityCalenderModel ava = is_in_aval(calendar, calendardata);
                boolean inaval = false ;
                if (ava!=null)
                    inaval=true;

                calendarListener.onDateSelected(calendar.getTime(),inaval,ava);
            }
        }
    };
    ...
    public void setcalendardata(List<ActivityCalenderModel> calendardata) {
