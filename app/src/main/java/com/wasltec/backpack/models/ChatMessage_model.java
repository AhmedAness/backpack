...
public class ChatMessage_model {
    ...
    public ChatMessage_model(int messageReplayId, int userId, int regardingId, String message, String date, String user_name, String userPhoto_Url, String typeId) {
